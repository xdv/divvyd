...
A distributed agreement protocol. Divvy uses the consensus process to solve
...
the transaction increments the sequence number.  This is how divvy prevents
...
**index:** 256-bit hash of this DivvyState.
...
The Divvy server permits clients to subscribe to a continuous stream of
