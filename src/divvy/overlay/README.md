...
The _Divvy payment network_ consists of a collection of _peers_ running
...
establishment, defines the _Divvy peer protocol_ (_protocol_ in this context).
...
A cluster consists of more than one Divvy server under common
